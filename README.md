...
> 1. User simply copies the URL from its source application, 
> 2. User calls **myPopAI** app to store it immediately in a structured and user-friendly format for future retrieval, or as a source for NoteBookLM.
